...
class Error
{
    ...
    public static function init()
    {
        ...
        self::$UNAUTHRIZED = new Error('ER-401', 'Unaothorized access! User does not have access.');
        self::$INVALID_USER_CREDENTIALS = new Error('ER-403', 'Invalid credentials! Email or Password is invalid.');
